...
author: 'Brian Ooi'
minuteRead: '20'
cover: "https://res.cloudinary.com/dl3rdpbpw/image/upload/v1722095031/analytics_wgfpgz.png"
...
Normally I would jump in joy for a client that values analytics. 
The problem is, without context for analysing data, analytics reporting is doomed to be a mess of cherry-picked, lazily crafted narratives about driving traffic and an incoherent mess of reporting metrics that do not provide intelligence much less drive action, which was exactly what the meeting became. 
